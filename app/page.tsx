  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-900 via-red-800 to-red-900">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-400 rounded-3xl shadow-2xl p-8 sm:p-12 border-4 border-yellow-500 animate-pulse">
          <div className="text-center">
            <div className="text-6xl sm:text-8xl mb-6">🏆</div>
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-black text-gray-900 mb-6 drop-shadow-lg">
              ¡TENEMOS GANADOR!
            </h2>
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-10 mb-8 shadow-xl">
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-700 mb-3">
                Boleto Ganador
              </p>
              <p className="text-6xl sm:text-8xl md:text-9xl font-black text-red-600 mb-4">
                #299
              </p>
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">
                Mildred Chávez Vigil
              </p>
            </div>
            
            {/* YouTube Channel Section */}
            <div className="bg-red-600 rounded-2xl p-6 sm:p-8 mt-8 shadow-2xl">
              <p className="text-white text-xl sm:text-2xl font-bold mb-4">
                🎥 Mira el sorteo completo en nuestro canal
              </p>
              <a
                href="https://www.youtube.com/@rifaaltruista"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-8 sm:px-12 py-4 sm:py-6 bg-white text-red-600 rounded-xl font-black text-2xl sm:text-4xl hover:bg-gray-100 transition-all transform hover:scale-105 shadow-2xl"
              >
